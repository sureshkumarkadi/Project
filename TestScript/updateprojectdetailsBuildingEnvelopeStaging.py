...
##                time.sleep(4)
                ...
                env = BuildingEnvelops1.readfromXML(folder_path+'\Env\Setup.xml','eTender','env')
                ...
                if env == 'StageURL':
                    ...
                    BuildingEnvelops_path = BuildingEnvelops1.readfromXML(folder_path+'\Object\Pairwiserupdateproject.xml','eTender','BuildingEnvelops') #Validate image id
                    BuildingEnvelops = browser.find_element_by_xpath(BuildingEnvelops_path)
