...
tf = 'test_addInternalURL'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = TC1027
class AddInternalURL(unittest.TestCase):
    def test_addInternalURL(self):
        try:
            ...
            time.sleep(1)
            Documentname_path = Documentname1.readfromXML(folder_path+'\Object\Project.xml','eTender','internaldocumentname')
