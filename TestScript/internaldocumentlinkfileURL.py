...
#filename = 'TestCase-TC1027-{0}.png'.format(ptime)
tf = 'test_internaldocumentlinkfileURL'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = TC1027-1
class InternaldocumentlinkfileURL(unittest.TestCase):
    def test_internaldocumentlinkfileURL(self):
        try:
            ...
            time.sleep(1)
            self.assertTrue('https://jira.causeway.com/secure/attachment/47719/JSON%20Object.txt' in browser.page_source)
