...
#filename = 'TestCase-100364-{0}.png'.format(ptime)
tf = 'test_TendercreationBalustradingMaterial'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100364
class TendercreationBalustradingMaterial(unittest.TestCase):
