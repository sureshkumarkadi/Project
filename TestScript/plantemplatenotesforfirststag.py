...
#filename = 'TestCase-100263-{0}.png'.format(ptime)
tf = 'test_Plantemplatenotesforfirststag'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100263
class Plantemplatenotesforfirststag(unittest.TestCase):
