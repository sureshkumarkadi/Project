...
#filename = 'TestCase-100285-{0}.png'.format(ptime)
tf = 'test_Plantemplatestagnotesdelete'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100285
class Plantemplatestagnotesdelete(unittest.TestCase):
    def test_Plantemplatestagnotesdelete(self):
        try:
            ...
            time.sleep(1)
            browser = tendertemplate.deletenotesforstag(browser) #clear/delete Notes for Stag
            time.sleep(3)
