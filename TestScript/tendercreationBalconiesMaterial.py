...
#filename = 'TestCase-100373-{0}.png'.format(ptime)
tf = 'test_TendercreationBalconiesMaterial'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100373
class TendercreationBalconiesMaterial(unittest.TestCase):
