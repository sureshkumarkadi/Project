...
tf = 'test_registersupplierselectorg'
...
##            time.sleep(1)
            logs.info("Test Case No : 100164 Passed Successfully")
        except Exception:
            logs.error("Validation with Test Case No: 100164 failed")
            browser.save_screenshot(fullpath)
            traceback.print_exc(file=sys.stdout)
            self.fail("Test Case No: 100164 failed")
            browser.implicitly_wait(5)
        finally:
