...
tf = 'test_updateprojectdetailsDrainage'
    ...
    def test_updateprojectdetailsDrainage(self):
        try:
            ...
            while i<14:
                ...
                env = Drainage1.readfromXML(folder_path+'\Env\Setup.xml','eTender','env')


                if env == 'StageURL':

                    Drainage_path = Drainage1.readfromXML(folder_path+'\Object\PairwiserupdateprojectStaging.xml','eTender','Drainage') #Validate image id
