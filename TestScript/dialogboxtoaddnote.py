...
#filename = 'TestCase-100023-{0}.png'.format(ptime)
tf = 'test_dialogboxtoAddnote'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case number = 100023
class Dialogboxtoaddnote(unittest.TestCase):
    def test_dialogboxtoAddnote(self):
        try:
            ...
            dialogbox_path = dialogbox1.readfromXML(folder_path+'\Object\Object.xml','eTender','dialogbox') #dialogbox
            time.sleep(1)
