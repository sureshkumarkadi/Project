...
#filename = 'TestCase-TC1054-{0}.png'.format(ptime)
tf = 'test_invitecolleaguelink'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case number = TC1054
class Invitecolleaguelink(unittest.TestCase):
    def test_invitecolleaguelink(self):
        try:
            ...
            self.assertEqual(emailinvite.text,'Email not in the list? Send invite directly')
