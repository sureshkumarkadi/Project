...
#filename = 'TestCase-100321-{0}.png'.format(ptime)
tf = 'test_plantemplateAutofillduedateasforecastdate'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100321
class PlantemplateAutofillduedateasforecastdate(unittest.TestCase):
