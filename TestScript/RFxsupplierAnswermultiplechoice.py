...
tf = 'test_RFxsupplieranswermultiplechoice'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = RFx-6
class RFxsupplieranswermultiplechoice(unittest.TestCase):
    def test_RFxsupplieranswermultiplechoice(self):
        try:
