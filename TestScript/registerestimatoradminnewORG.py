...
#filename = 'TestCase-100169-{0}.png'.format(ptime)
tf = 'test_registerestimatoradminneworg'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100169
class RegisterestimatoradminnewORG(unittest.TestCase):
