...
#filename = 'TestCase-100331-{0}.png'.format(ptime)
tf = 'test_viewdeleteditemsinsupplier'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100331
class Viewdeleteditemsinsupplier(unittest.TestCase):
