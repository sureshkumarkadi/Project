...
#filename = 'TestCase-100233-{0}.png'.format(ptime)
tf = 'test_tradexsuppliercontact'
filename = 'Testcase-%s.png' %(tf)
path= setupValue().screenpath
fullpath = os.path.join(path,filename)

#Test case Number = 100233
class Tradexsuppliercontact(unittest.TestCase):
...
##            time.sleep(7)
            ...
            self.assertEqual(suppliercontact2,'hanks.civils@mailinator.com')
            time.sleep(1)
