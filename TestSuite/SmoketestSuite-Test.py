...
###
###Added on 17/10/2017
##suite.addTest(StartDateAsForecast('ForeCastDate'))
##suite.addTest(DueDateAsForecast('DueCastDate'))
##suite.addTest(ExportToExcel('ExcelExport'))
##suite.addTest(ExportToDetailsExcel('ExcelDetailsExport'))
##
###Added on 01/12/2017
##
##suite.addTest(FootNoteClass('FootNote'))
##suite.addTest(EmailSetupPage('SetupEmailPage'))
...
filename = 'SmokeTestExecutionReport-{0}'.format(ptime)
