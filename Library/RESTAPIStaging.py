...
class ReopentenderusingRESTAPIclass():
      def AuthunticateAPI(self):
            ...
            if env == 'StageURL':
                    ...
                    stageURL = StageURL + 'tenderservices/api/signin'
                    Login = {'email':Username,'password':Password}

                    headers = {'Content-type': 'application/x-www-form-urlencoded'}

                    response = requests.post(stageURL,data=Login,headers=headers)
                    ...
                    preStageURL = PreStageURL + 'tenderservices/api/signin'

                    Login = {'email':Username,'password':Password}

                    headers = {'Content-type': 'application/x-www-form-urlencoded'}

                    response = requests.post(preStageURL,data=Login,headers=headers)
                    ...
                    masterURL = MasterURL + 'tenderservices/api/signin'
                    Login = {'email':Username,'password':Password}

                    headers = {'Content-type': 'application/x-www-form-urlencoded'}

                    response = requests.post(masterURL,data=Login,headers=headers)
