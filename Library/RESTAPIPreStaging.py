...
class ReopentenderusingRESTAPIclass():
      def AuthunticateAPI(self):
            time.sleep(1)
            #APIDetails = DataDriver()
            Username =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','username')
            Password =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','password')
      ...
      def ReopentenderusingRESTAPI(self,accesstoken):
            ...
            TenderID =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','tenderID')
            TendererReferenceID =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','tendererReferenceID')

            ##url = 'http://bg-etender-ser:8080/tenderservices/api/tender/{0}/notify/reopentender'.format(TenderID) # {0} - Passing tender ID = 18837
            url = 'http://bg-etender-ser:8080/tenderservices/api/tender/{0}/notify/reopentender'.format(TenderID) # {0} - Passing tender ID = 18837
...
#create project
      ...
      def Createproject(self,accesstoken):
            ...
            Projectname =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','projectname')
            Projectdescription =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','projectdescription')
            ProjectRef =APIDetails.readfromXML(folder_path+'\Data\APIdetailsPreStaging.xml','eTender','projectRef')
